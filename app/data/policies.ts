...
const NATIONAL_SOURCE: Source = {
  ...
  issuer: "国务院令第619号",
  article: "第七条",
  url: "https://www.moj.gov.cn/pub/sfbgw/flfggz/flfggzfgjd/201205/t20120508_151657.html",
};
...
const shanghai: JurisdictionPolicy = {
  ...
  cesareanDays: 15,
  multipleBirthDaysPerAdditionalChild: 15,
  localSourceIds: ["shanghai_regulation", "shanghai_counting"],
  notes: [
...
const zhejiang: JurisdictionPolicy = {
  ...
  cesareanDays: 15,
  multipleBirthDaysPerAdditionalChild: 15,
  localSourceIds: ["zhejiang_insurance", "zhejiang_women"],
  notes: [
...
const jiangsu: JurisdictionPolicy = {
  ...
  cesareanDays: 15,
  multipleBirthDaysPerAdditionalChild: 15,
  localSourceIds: ["jiangsu_regulation", "jiangsu_158", "jiangsu_counting"],
  notes: [
  ...
  sources: [
    ...
    },
    {
      ...
      url: "https://www.suzhou.gov.cn/2018cfxd_14292/rdwd/201912/8d62b9ceda24441b9091ed04518993a0.shtml",
    },
  ],
};
...
const shaanxi: JurisdictionPolicy = {
  ...
  localSourceIds: ["shaanxi_regulation", "shaanxi_guidance"],
...
const henan: JurisdictionPolicy = {
  ...
  cesareanDays: 15,
  multipleBirthDaysPerAdditionalChild: 15,
  localSourceIds: ["henan_regulation", "zhengzhou_188"],
  notes: [
...
const hunan: JurisdictionPolicy = {
  ...
  sources: [
    NATIONAL_SOURCE,
    {
      ...
      issuer: "湖南省人大常委会",
      article: "第十六条",
      url: "https://www.hunan.gov.cn/hnyw/zwdt/202112/t20211204_21236900.html",
    },
    {
      id: "hunan_women",
...
const anhui: JurisdictionPolicy = {
  ...
  cesareanDays: 15,
  multipleBirthDaysPerAdditionalChild: 15,
  localSourceIds: ["anhui_regulation", "anhui_guidance"],
  notes: [
  ...
  sources: [
    ...
    },
    {
      ...
      article: "假期计算口径",
      url: "https://wsjkw.tl.gov.cn/tlswsjkwyh/c00010/pc/content/content_1686672897484840960.html",
    },
  ],
};
...
const shandong: JurisdictionPolicy = {
  ...
  sources: [
    NATIONAL_SOURCE,
    {
      ...
      article: "第二十六条",
      url: "https://wjw.taian.gov.cn/art/2025/1/23/art_45778_10321548.html",
    },
    {
...
const fujian: JurisdictionPolicy = {
  ...
  localSourceIds: ["fujian_regulation", "fujian_women", "fujian_faq"],
  notes: [
